<script lang="ts">
  ...
  function reconcileAudioTransport(deckId: string, playing: boolean) {
   ...
   * full 10s budget. Call alongside `lastAudioPlaying.delete(deckId)`.
   */
  function cancelAudioTransport(deckId: string) {
